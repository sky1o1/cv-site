            ...
            <div id="lonon-main">
                ...
                <div class="lonon-services">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12"> <span className={`${greyGradient} ${blackGradient} ${whiteGradient} ${blueGradient} heading-meta style-1`} >What We Do</span>
                                <h2 class="lonon-heading animate-box" className={`${greyGradient} ${blackGradient} ${whiteGradient} ${blueGradient}`} data-animate-effect="fadeInLeft">Services</h2> </div>
                        </div>
